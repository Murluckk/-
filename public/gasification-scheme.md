...
## Технологическая и операторная схемы газогенераторной установки
...
>
> **Операторная схема** — это чертёж, на котором каждый элемент системы (аппарат) изображается пунктирным прямоугольником и представлен совокупностью **типовых технологических операторов**, а технологические соединения между элементами — направленными линиями. См. раздел 9 и файл [`gasification-operator-scheme.svg`](./gasification-operator-scheme.svg).
...
### 9.1 Условные обозначения операторов
...
### 9.2 Состав операторов по аппаратам
...
### 9.3 Графическая операторная схема
